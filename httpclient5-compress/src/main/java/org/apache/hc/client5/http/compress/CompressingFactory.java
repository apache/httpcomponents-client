...
public class CompressingFactory {
    ...
    private final Set<String> inputProvidersCache;
    private final Set<String> outputProvidersCache;
    ...
    private CompressingFactory() {
        ...
        for (final CompressionHandler h : handlers) {
            in.addAll(h.getSupportedInputFormats());
        }
        this.inputProvidersCache = Collections.unmodifiableSet(in);

        final Set<String> out = new HashSet<>();
        for (final CompressionHandler h : handlers) {
            out.addAll(h.getSupportedOutputFormats());
        }
        this.outputProvidersCache = Collections.unmodifiableSet(out);
    }
