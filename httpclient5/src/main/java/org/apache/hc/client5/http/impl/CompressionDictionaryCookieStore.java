...
@Internal
public final class CompressionDictionaryCookieStore implements CookieStore {

    private final CookieStore delegate;
    private final CompressionDictionaryStore compressionDictionaryStore;

    public CompressionDictionaryCookieStore(
    ...
    public boolean isBoundTo(final CompressionDictionaryStore store) {
