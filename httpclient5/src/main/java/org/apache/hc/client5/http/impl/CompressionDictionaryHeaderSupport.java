 ...
 */
@Internal
public final class CompressionDictionaryHeaderSupport {
     ...
     */
    public static String formatAvailableDictionary(final byte[] hash) {
     ...
     */
    public static String formatDictionaryId(final String value) {
