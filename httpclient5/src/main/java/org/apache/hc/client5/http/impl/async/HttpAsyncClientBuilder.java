...
public class HttpAsyncClientBuilder {
     ...
     */
    private LinkedHashMap<String, UnaryOperator<AsyncEntityConsumer<?>>> contentDecoderMap;
    ...
    public HttpAsyncClientBuilder setContentDecoderMap(
            final LinkedHashMap<String, UnaryOperator<AsyncEntityConsumer<?>>> contentDecoderMap) {
