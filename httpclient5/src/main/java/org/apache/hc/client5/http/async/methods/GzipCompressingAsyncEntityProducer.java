...
public final class GzipCompressingAsyncEntityProducer implements AsyncEntityProducer {
    ...
    public GzipCompressingAsyncEntityProducer(final AsyncEntityProducer delegate) throws IOException {
    ...
    public void produce(final DataStreamChannel channel) throws IOException {
        ...
        if (!started) {
            gzipStream = new GZIPOutputStream(new ChannelBoundOutputStream(channel, outputBuffer));
            started = true;
        }

        delegate.produce(new CompressingDataStreamChannel(channel));

        // If delegate is done, finish GZIP
    ...
    private class CompressingDataStreamChannel implements DataStreamChannel {
        ...
        public int write(final ByteBuffer src) throws IOException {
            ...
            gzipStream.flush(); // Flush to produce compressed output incrementally
