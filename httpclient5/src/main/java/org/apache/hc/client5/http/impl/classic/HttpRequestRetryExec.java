 ...
 *
 * <pre>{@code
    clientBuilder.addExecInterceptorBefore(ChainElement.RETRY.name(), "MyCustomHandler", handler);
 * }</pre>
 * </p>
 *
 * <p>
 ...
 *
 * <pre>{@code
    clientBuilder.addExecInterceptorAfter(ChainElement.RETRY.name(), "MyCustomHandler", handler);
}</pre>
 * </p>
 *
 * @since 5.0
