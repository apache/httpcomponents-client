...
public class ClientConfiguration {
    ...
    public final static void main(final String[] args) throws Exception {
        ...
        final RequestConfig defaultRequestConfig = RequestConfig.custom()
            ...
            .setTargetPreferredAuthSchemes(Arrays.asList(StandardAuthScheme.NTLM.id, StandardAuthScheme.DIGEST.id))
            .setProxyPreferredAuthSchemes(Arrays.asList(StandardAuthScheme.BASIC.id))
            .build();
