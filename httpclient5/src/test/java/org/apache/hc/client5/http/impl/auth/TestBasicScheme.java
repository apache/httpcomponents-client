...
public class TestBasicScheme {
    ...
    public void testBasicAuthenticationEmptyChallenge() throws Exception {
        final String challenge = StandardAuthScheme.BASIC.id;
    ...
    public void testBasicAuthenticationWith88591Chars() throws Exception {
        ...
        Assert.assertEquals(StandardAuthScheme.BASIC.id + " ZGg65C32Lfw=", authResponse);
    }

    @Test
    public void testBasicAuthentication() throws Exception {
        final AuthChallenge authChallenge = parse(StandardAuthScheme.BASIC.id + " realm=\"test\"");
        ...
        final String expected = StandardAuthScheme.BASIC.id + " " + new String(
