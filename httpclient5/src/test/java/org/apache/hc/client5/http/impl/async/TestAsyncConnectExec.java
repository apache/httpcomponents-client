...
class TestAsyncConnectExec {
     ...
     */
    private HttpRequest tunnelConnectRequest(final AsyncConnectExec exec, final HttpRoute route,
            final HttpVersionPolicy versionPolicy) throws Exception {
        final HttpClientContext context = HttpClientContext.create();
        if (versionPolicy != null) {
            context.setHttpVersionPolicy(versionPolicy);
        }
    ...
    void testEstablishRouteViaProxyTunnelAddsAlpnHeader() throws Exception {
        ...
        final HttpRequest connect = tunnelConnectRequest(exec, route, null);
    ...
    void testEstablishRouteViaProxyTunnelAlpnHeaderReflectsVersionPolicy() throws Exception {
        ...
        final HttpRequest connect = tunnelConnectRequest(exec, route, HttpVersionPolicy.FORCE_HTTP_1);
