...
/**
 * <h2>Example: DNS destination address ordering + Happy Eyeballs-style connection racing</h2>
 *
 * <p>This example shows how to:</p>
 * <ul>
 *   <li>Wrap the system DNS resolver with {@link AddressSelectingDnsResolver}
 *       to apply destination address selection (IPv6/IPv4 ordering).</li>
 *   <li>Use {@link ConnectionConfig} to enable <b>Happy Eyeballs-style</b> concurrent
 *       connection attempts with pacing and a <b>protocol family preference</b>
 ...
 * </ul>
 *
 * <p><b>Note:</b> DNS resolution is synchronous (the JDK does not expose separate
 * AAAA/A queries), so this implementation covers the connection-racing aspects of
 * Happy Eyeballs but not the asynchronous dual-query DNS behavior.</p>
 *
 * <h3>How to run with the example runner</h3>
 * <pre>
 * # Default (no args): hits <a href="http://ipv6-test.com/">...</a> and <a href="https://ipv6-test.com/">...</a>
