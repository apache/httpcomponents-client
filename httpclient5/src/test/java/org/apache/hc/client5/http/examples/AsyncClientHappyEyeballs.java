...
/**
 * This example demonstrates how to use Happy Eyeballs V2 for dual-stack address resolution and staggered connection attempts.
 */
public final class AsyncClientHappyEyeballs {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final HappyEyeballsV2AsyncClientConnectionOperator operator = new HappyEyeballsV2AsyncClientConnectionOperator(dnsResolver);
