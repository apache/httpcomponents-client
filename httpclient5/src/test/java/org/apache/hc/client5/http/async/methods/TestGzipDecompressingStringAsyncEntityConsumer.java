...
class TestGzipDecompressingStringAsyncEntityConsumer {
    ...
    private GzipDecompressingStringAsyncEntityConsumer consumer;
    ...
    void setUp() {
        ...
        consumer = new GzipDecompressingStringAsyncEntityConsumer();
    ...
    void testDecompressChunkedInput() throws IOException, HttpException, InterruptedException {
        ...
        try (final GZIPOutputStream gzipOut = new GZIPOutputStream(compressedOut)) {
            gzipOut.write(original.getBytes(StandardCharsets.UTF_8));
        }
