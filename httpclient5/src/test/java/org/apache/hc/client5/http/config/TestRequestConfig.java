...
public class TestRequestConfig {
    ...
    public void testBuildAndCopy() throws Exception {
        final RequestConfig config0 = RequestConfig.custom()
                ...
                .setTargetPreferredAuthSchemes(Collections.singletonList(StandardAuthScheme.NTLM.id))
                .setProxyPreferredAuthSchemes(Collections.singletonList(StandardAuthScheme.DIGEST.id))
        ...
        Assert.assertEquals(Collections.singletonList(StandardAuthScheme.NTLM.id), config.getTargetPreferredAuthSchemes());
        Assert.assertEquals(Collections.singletonList(StandardAuthScheme.DIGEST.id), config.getProxyPreferredAuthSchemes());
