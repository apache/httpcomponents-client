...
public class TestAuthenticationStrategy {
    ...
    public void testSelectNoSchemeRegistry() throws Exception {
        ...
        challenges.put(StandardAuthScheme.BASIC.id.toLowerCase(Locale.ROOT), new AuthChallenge(ChallengeType.TARGET, StandardAuthScheme.BASIC.id,
                new BasicNameValuePair("realm", "test")));
        challenges.put(StandardAuthScheme.DIGEST.id.toLowerCase(Locale.ROOT), new AuthChallenge(ChallengeType.TARGET, StandardAuthScheme.DIGEST.id,
    ...
    public void testUnsupportedScheme() throws Exception {
        ...
        final Registry<AuthSchemeFactory> authSchemeRegistry = RegistryBuilder.<AuthSchemeFactory>create()
            ...
            .register(StandardAuthScheme.DIGEST.id, DigestSchemeFactory.INSTANCE).build();
    ...
    public void testCustomAuthPreference() throws Exception {
        ...
        final RequestConfig config = RequestConfig.custom()
            .setTargetPreferredAuthSchemes(Collections.singletonList(StandardAuthScheme.BASIC.id))
            .build();
