...
public class TestDigestScheme {
    ...
    public void testDigestAuthenticationEmptyChallenge1() throws Exception {
        final AuthChallenge authChallenge = parse(StandardAuthScheme.DIGEST.id);
    ...
    public void testDigestAuthenticationWithDefaultCreds() throws Exception {
        ...
        final String challenge = StandardAuthScheme.DIGEST.id + " realm=\"realm1\", nonce=\"f2a3f18799759d4f1a1c068b92b573cb\"";
    ...
    public void testDigestAuthenticationWithSHA() throws Exception {
        ...
        final String challenge = StandardAuthScheme.DIGEST.id + " realm=\"realm1\", " +
    ...
    public void testDigestAuthenticationNoRealm() throws Exception {
        ...
        final String challenge = StandardAuthScheme.DIGEST.id + " no-realm=\"realm1\", nonce=\"f2a3f18799759d4f1a1c068b92b573cb\"";
        final AuthChallenge authChallenge = parse(challenge);
        final DigestScheme authscheme = new DigestScheme();
        authscheme.processChallenge(authChallenge, null);
    ...
    public void testDigestAuthenticationNoNonce() throws Exception {
        ...
        final String challenge = StandardAuthScheme.DIGEST.id + " realm=\"realm1\", no-nonce=\"f2a3f18799759d4f1a1c068b92b573cb\"";
        final AuthChallenge authChallenge = parse(challenge);
        final DigestScheme authscheme = new DigestScheme();
        authscheme.processChallenge(authChallenge, null);
    ...
    public void testDigestAuthenticationMD5Sess() throws Exception {
        ...
        final String challenge=StandardAuthScheme.DIGEST.id + " realm=\"" + realm + "\", "
            + "nonce=\"" + nonce + "\", "
            + "opaque=\"SomeString\", "
            + "stale=false, "
            + "algorithm=MD5-sess, "
    ...
    private static Map<String, String> parseAuthResponse(final String authResponse) {
        if (!authResponse.startsWith(StandardAuthScheme.DIGEST.id + " ")) {
            return null;
        }
    ...
    public void testDigestNouceCount() throws Exception {
        ...
        final String challenge1 = StandardAuthScheme.DIGEST.id + " realm=\"realm1\", nonce=\"f2a3f18799759d4f1a1c068b92b573cb\", qop=auth";
        ...
        final String challenge2 = StandardAuthScheme.DIGEST.id + " realm=\"realm1\", nonce=\"f2a3f18799759d4f1a1c068b92b573cb\", qop=auth";
        ...
        final String challenge3 = StandardAuthScheme.DIGEST.id + " realm=\"realm1\", nonce=\"e273f1776275974f1a120d8b92c5b3cb\", qop=auth";
    ...
    public void testDigestMD5SessA1AndCnonceConsistency() throws Exception {
        ...
        final String challenge1 = StandardAuthScheme.DIGEST.id + " qop=\"auth\", algorithm=MD5-sess, nonce=\"1234567890abcdef\", " +
        ...
        final String challenge2 = StandardAuthScheme.DIGEST.id + " qop=\"auth\", algorithm=MD5-sess, nonce=\"1234567890abcdef\", " +
            "charset=utf-8, realm=\"subnet.domain.com\"";
        final AuthChallenge authChallenge2 = parse(challenge2);
        authscheme.processChallenge(authChallenge2, null);
        Assert.assertTrue(authscheme.isResponseReady(host, credentialsProvider, null));
        ...
        final String challenge3 = StandardAuthScheme.DIGEST.id + " qop=\"auth\", algorithm=MD5-sess, nonce=\"fedcba0987654321\", " +
            "charset=utf-8, realm=\"subnet.domain.com\"";
        final AuthChallenge authChallenge3 = parse(challenge3);
        authscheme.processChallenge(authChallenge3, null);
        Assert.assertTrue(authscheme.isResponseReady(host, credentialsProvider, null));
    ...
    public void testParameterCaseSensitivity() throws Exception {
        ...
        final String challenge = StandardAuthScheme.DIGEST.id + " Realm=\"-\", " +
