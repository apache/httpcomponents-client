 ...
 */
@Internal
final class SseResponseConsumer implements AsyncResponseConsumer<Void> {
    ...
    SseResponseConsumer(final AsyncEntityConsumer<Void> entity, final LongConsumer retryHintSink) {
        this.entity = entity;
    ...
    public void consumeResponse(final HttpResponse rsp, final EntityDetails ed, final HttpContext ctx,
                                final org.apache.hc.core5.concurrent.FutureCallback<Void> cb)
