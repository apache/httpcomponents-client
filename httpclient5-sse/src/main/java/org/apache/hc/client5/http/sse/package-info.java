 ...
 *       {@link org.apache.hc.client5.http.sse.NoBackoffStrategy}.</li>
 *   <li>{@link org.apache.hc.client5.http.sse.SseParser} — choose between a spec-friendly
 ...
 *   <li><b>Parser:</b> {@link org.apache.hc.client5.http.sse.SseParser#CHAR} (default) is spec-compliant;
 ...
 *
 * <h2>Internals</h2>
 * <p>Implementation classes annotated with {@code @Internal} (for example,
 * {@code DefaultEventSource}, {@code SseResponseConsumer}, {@code ServerSentEventReader},
 * and the concrete entity consumers) are not part of the public API and may change without notice.</p>
 *
 * @since 5.6
 */
