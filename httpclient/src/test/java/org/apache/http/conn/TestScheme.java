...
public class TestScheme {
    ...
    public void testConstructor() {
        ...
        final Scheme https = new Scheme("https", 443, SecureSocketFactoryMockup.INSTANCE);
    ...
    public void testRegisterUnregister() {
        final SchemeRegistry schmreg = new SchemeRegistry();

        final Scheme http = new Scheme("http", 80, PlainSocketFactory.getSocketFactory());
        final Scheme https = new Scheme("https", 443, SecureSocketFactoryMockup.INSTANCE);
        final Scheme myhttp = new Scheme("http", 80, PlainSocketFactory.getSocketFactory());

        final HttpHost host  = new HttpHost("www.test.invalid", -1, "http");
        final HttpHost hosts = new HttpHost("www.test.invalid", -1, "https");
