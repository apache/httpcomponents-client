...
/**
 * Example WebSocket echo client using HTTP/1.1 Upgrade.
 *
 * <p>This example demonstrates how to build a {@link CloseableWebSocketClient},
 * connect to a WebSocket endpoint over an HTTP/1.1 Upgrade handshake, send a
 * text message with per-message deflate compression enabled, receive the echoed
 * response, and then perform a clean close handshake.</p>
 *
 * <p>The client is configured with the following compression options:</p>
 * <ul>
 ...
 * <ol>
 *   <li>Build and start the client via {@link WebSocketClientBuilder}</li>
 *   <li>Connect asynchronously using a {@link WebSocketListener} callback</li>
 *   <li>On open, send a large text payload to exercise compression</li>
 *   <li>On receiving the echo, initiate a close with status code 1000</li>
 *   <li>Await completion and shut down the client gracefully</li>
 * </ol>
 *
 * <h2>Usage</h2>
 * <pre>
 ...
 * </pre>
 *
 * <p>Pair with {@link WebSocketEchoServer} for a complete local test.</p>
 *
 * @since 5.7
 */
