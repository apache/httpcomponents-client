...
abstract class AbstractClassicOverAsyncIntegrationTestBase {
    ...
    protected AbstractClassicOverAsyncIntegrationTestBase(final URIScheme scheme,
    ...
    public CloseableHttpClient startClient() throws Exception {
        ...
        client.start();
        return new ClassicToAsyncAdaptor(client, TIMEOUT);
    }
