 ...
 * deserializable by the configured Jackson {@link ObjectMapper},
 * {@link jakarta.ws.rs.core.Response}, or {@link jakarta.ws.rs.core.Request}. Any of
 * these may also be wrapped in {@link java.util.concurrent.CompletionStage} or
 ...
 * the caller for direct inspection. The {@link jakarta.ws.rs.core.Request} return
 * type yields a value exposing only the dispatched HTTP method; the server-side
 * {@code selectVariant} and {@code evaluatePreconditions} methods are not
 * supported and throw {@link UnsupportedOperationException}.</p>
 *
